In previous posts ([Zero Trust](/blog/absolute-security-with-no-trust/), [MPC-1](/blog/oblivious-transfer/)), I described the importance of Secure Multiparty Computation
...
they need to collect all the content that you type and analyze them (see their [privacy policy](https://www.grammarly.com/privacy-policy)). I am NOT
...
Computation. The current state-of-the-art papers ([ABY3](https://eprint.iacr.org/2018/403.pdf), [SecureNN](https://eprint.iacr.org/2018/442.pdf)) propose a 3-party setting. In
...
done by the folks at [Dropout Labs](https://dropoutlabs.com/). They are working an a secure version of Tensorflow,
called [tf-encrypted](https://tf-encrypted.io/) which implements the above papers in addition to the [SPDZ](https://bristolcrypto.blogspot.com/2016/10/what-is-spdz-part-1-mpc-circuit.html)
protocol.

If you want to implement the protocols yourself, you can checkout the [MPC-SoK](https://github.com/MPC-SoK/frameworks) repository. Marcella Hastings, et al
...
(e.g., [Secret Sharer](https://arxiv.org/pdf/1802.08232.pdf)). Assume Alice is a data owner and one of the inputs she has sent to cloud has
...
data, or using techniques such as [Differential Privacy](https://en.wikipedia.org/wiki/Differential_privacy) (DP).
...
Of course, as I have mentioned in my [previous post](/blog/absolute-security-with-no-trust/), having the theoretical solution is not enough and there
many more more things that need to be considered before such an application can be ready for secure production use.

I encourage you to checkout the tutorials on [tf-encrypted with keras and DP](https://github.com/tf-encrypted/tf-encrypted/tree/master/examples/notebooks/keras-classification) and [PySyft](https://github.com/OpenMined/PySyft/tree/dev/examples/tutorials) for a
